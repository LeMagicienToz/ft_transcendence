            ...
            try:
                ...
                try:
                    ...
                    if redis_token and redis_token.decode() != access_token:
                        return JsonResponse({'success': False, 'error': 'Access token revoqué'}, status=401)
                ...
                if refresh_token:
                    try:
                        ...
                        if redis_refresh_token and redis_refresh_token.decode() != refresh_token:
                            return JsonResponse({'success': False, 'error': 'Refresh token revoqué'}, status=401)
                    ...
                    return JsonResponse({'success': False, 'error': 'Access token expire et refresh token manquand'}, status=401)
            except jwt.InvalidTokenError:
                return JsonResponse({'success': False, 'error': 'Access token invalide'}, status=400)
        else:
            return JsonResponse({'success': False, 'error': 'Access token manquand'}, status=400)
