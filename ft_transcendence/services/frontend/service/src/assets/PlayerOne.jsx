...
const PlayerOne = ({ position = [0, 0, 0], suitColor = "#ffffff", visColor = "#ffffff", ringsColor = "#ffffff", bpColor = "#ffffff", paddleColor = "#ffffff", flatness = 7.0, horizontalPosition = 7.5, verticalPosition = 0.0, visTexture = '' }) => {
    const { scene } = useGLTF('/gltf/PlayerOne.gltf') || {};
...
useGLTF.preload('/gltf/PlayerOne.gltf');
