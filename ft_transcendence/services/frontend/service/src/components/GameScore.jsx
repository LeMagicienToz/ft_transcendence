    ...
    return (
        <div className={`game-score row`} >
            <div className={`player one row`} >
                <div className={`avatar`} style={{backgroundImage: `url("${players[0]?.user_info.profile_picture_url}")` }} ></div>
                <div className={`info`} >
            ...
            <div className={`player two row`} >
                ...
                <div className={`avatar`} style={{backgroundImage: `url("${players[1]?.user_info.profile_picture_url}")` }} ></div>
            </div>
        </div>
    );
}
